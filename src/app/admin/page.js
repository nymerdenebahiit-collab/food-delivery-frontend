...
const Admin = () => {
  ...
  return (
    <>
      <div
        className={`w-[1440px] flex relative ${
          activePopUpMenu
            ? `blur-sm opacity-75`
      ...
      {activePopUpMenu && foodMenu && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <div
            aria-label="The rectangle"
            className="bg-white p-6 flex flex-col gap-6 w-115 rounded-lg"
          >
            <div
            ...
            >
              ...
              <button
                ...
                className="h-9 w-9 bg-[#E4E4E5] flex items-center justify-center rounded-full cursor-pointer"
              >
                <svg
                  className="w-3 h-3"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex flex-col gap-2">
              ...
              <Input type="" placeholder="Type category name..." />
            </div>
            <button
              aria-label="Add Category"
              className="text-[#FAFAFA] ml-70  text-sm font-normal py-2 px-4 flex w-fit items-center justify-center bg-[#18181B] rounded-md cursor-pointer"
            >
              Add category
            </button>
          </div>
      ...
      {deliveryButtonClicked && orderMenu && (
        <div
        ...
        >
          <div
            aria-label=""
            className="p-6 bg-[#FFF] rounded-xl flex flex-col gap-6 w-91"
          >
            <div
              aria-label="Header"
              className="flex justify-between items-center"
            >
              <p className="text-sm font-medium">Change delivery state</p>
              <button
                onClick={() => setDeliveryButtonClicked(false)}
                className="h-9 w-9 bg-[#E4E4E5] flex items-center justify-center rounded-full cursor-pointer"
              >
                <svg
                  className="w-3 h-3"
            ...
            <div aria-label="Buttons" className="flex gap-4 ">
              <button className="border py-2 px-2.5 bg-[#F4F4F5] rounded-full hover:bg-[#E11D48]/10  hover:border-red-500 cursor-pointer">
                Delivered
              </button>
              <button className="border py-2 px-2.5 bg-[#F4F4F5] rounded-full hover:bg-[#E11D48]/10  hover:border-red-500 cursor-pointer">
                Pending
            ...
            <button
              aria-label="Set Delivery state"
              className="rounded-full py-2 px-3 flex items-center justify-center bg-[#18181B] font-semibold text-[#FAFAFA] cursor-pointer"
            >
              Save
            </button>
          </div>
      ...
      {addDishClicked && foodMenu && (
        <div className="fixed inset-0 flex items-center justify-center">
          <div
            ...
            className="p-6 bg-[#FFF] rounded-xl flex flex-col gap-6 w-115"
          >
            ...
            <div className="flex gap-6">
              {" "}
              <div className="flex flex-col gap-2">
                <p className="text-sm text-[#09090B] font-medium">Food name</p>
                <Input type="Food name" placeholder="Type food name" />
              </div>
              <div className="flex flex-col gap-2">
                <p className="text-sm text-[#09090B] font-medium">Food price</p>
                <Input type="Food price" placeholder="Enter price..." />
              </div>
            </div>
            <div className="flex flex-col gap-2">
              <p className="text-sm text-[#09090B] font-medium">Ingredients</p>
            ...
            <div
              ...
              className="border-2 border-dashed bg-[#E4E4E7] border-gray-300 rounded-md p-4 text-center cursor-pointer hover:border-gray-400 transition-colors"
            >
        ...
        >
          ...
          >
            ...
            >
              <p className="text-sm font-medium">Change delivery state</p>
              <button
                onClick={() => setEditDishClicked(false)}
                className="h-9 w-9 bg-[#E4E4E5] flex items-center justify-center rounded-full cursor-pointer"
              >
                <svg
                  className="w-3 h-3"
      ...
      {isEditDishClicked && foodMenu && (
        <div className="p-8">
          <Button onClick={() => setOpen(true)}>Open Dish Info</Button>
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid gap-2">
                  ...
                  <label
                    ...
                    className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center cursor-pointer hover:border-gray-400 transition-colors block h-48 items-center justify-center"
                  >
                    <div className="flex flex-col items-center gap-2">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
