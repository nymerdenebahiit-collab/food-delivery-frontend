...
const HeaderLoggedIn = () => {
  return (
    <div className="w-[1440px]  h-[148px] bg-[#18181B] flex justify-between items-center px-22 py-4">
      ...
      <div aria-label="Buttons section" className="flex gap-3 items-center">
        <div
          aria-label="Delivery address"
          className="flex bg-white gap-1 py-2 px-3 items-center rounded-full"
        >
          <svg
            aria-label="Location"
        ...
        <div
          aria-label="Shopping"
          className="rounded-full w-9 h-9  bg-white flex items-center justify-center"
        >
          <svg
        ...
        <div
          aria-label="User"
          className="w-9 h-9 flex items-center justify-center bg-red-500 rounded-full"
        >
          <svg
